...
?>
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="profile.php" class="nav-link text-body font-weight-bold px-2">
	...
	<input type="submit" value="Search" />
                            ...
                            <a href="logout.php" class="nav-link text-body font-weight-bold px-2">
...
$sql="select * from info where name is not null";
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="assets/img/logo-ct.png" class="avatar avatar-sm me-3">
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm"><?php echo $a; ?> - <?php echo $k; ?></h6>
                                                        <p class="text-xs text-secondary mb-0"><?php echo $f,$g,$h,$i,$j; ?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?php echo $b; ?></p>
                                                <p class="text-xs text-secondary mb-0"><?php echo $c; ?></p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-success"><?php echo $d; ?></span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?php echo $e; ?></span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                ...
                                <table class="table align-items-center justify-content-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Total Members</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">PM</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Status</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Skills</th>
                                    ...
                                    <tr>
                                            <td>
                                                <div class="d-flex px-2">
                                                    ...
                                                    <div class="my-auto">
                                                        <h6 class="mb-0 text-sm"><?php echo $m; ?></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                              <span class="text-xs font-weight-bold"><?php echo $n;?></span>
                                                
                                            </td>
                                            <td>
                                                <span class="text-xs font-weight-bold"><?php echo $p; ?></span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="text-secondary text-xs font-weight-bold"><?php echo $t; ?></span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    <span class="me-2 text-xs font-weight-bold"><?php echo $q; ?></span>
                                                </div>
                                            </td>
                                            <td class="align-middle text-center">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    <span class="me-2 text-xs font-weight-bold"><?php echo $r; ?>-<?php echo $s; ?></span>
                                                </div>
                                            </td>
                                            <td class="align-middle text-center">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    <div>
                                                        <div class="progress">
                                                            <div class="progress-bar bg-gradient-info" role="progressbar" aria-valuenow="$n" aria-valuemin="0" aria-valuemax="10" style="width:<?php echo $n*10; ?>%"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-left">
                                ...
                                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Team Hatchback</a> for Interapt Hacks.
                            </div>
                        </div>
                        <div class="col-lg-6">
