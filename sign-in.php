                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            ...
                            <div class="card-body">
                                <form role="form text-left" action="checklogin.php" method="post">
                                    <label>Email</label>
                                    <div class="mb-3">
                                        <input type="email" name="t1" class="form-control" placeholder="Email" aria-label="Email" aria-describedby="email-addon">
                                    </div>
