                ...
                <div class="collapse navbar-collapse me-md-0 me-sm-4 mt-sm-0 mt-2" id="navbar">
                    ...
                    <ul class="navbar-nav justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            ...
                            <a href="logout.php" class="nav-link text-white font-weight-bold px-2">
...
{
	?>
    <form style="height: 15px; width:10px;" method="post" enctype="multipart/form-data" action="uploadphoto.php">
...
{
	?>
    <img src="<?php echo $photo; ?>" alt="..." class="w-100 border-radius-lg shadow-sm">
    <a href="changephoto.php" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2">
    <?php
}
?>
                ...
                <div class="col-12 col-xl-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Full Name:</strong> &nbsp;<?php echo $a; ?> </li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong> &nbsp; <?php echo $c; ?></li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Email:</strong> &nbsp; alecthompsonn@interapt.com</li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Location:</strong> &nbsp; <?php echo $d; ?></li>
                            ...
                            <div class="row">
                                    ...
                                    <div class="card card-blog card-plain">
                                        <div class="position-relative">
                                            <a class="d-block shadow-xl border-radius-xl">
                                                <img src="assets/img/small-logos/logo-webdev.svg" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                            </a>
                                        </div>
                                ...
                                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                                    <div class="card card-blog card-plain">
                                        <div class="position-relative">
                                            <a class="d-block shadow-xl border-radius-xl">
                                                <img src="assets/img/small-logos/logo-webdev.svg" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg">
                                            </a>
                                        </div>
                                        <div class="card-body px-1 pb-0">
